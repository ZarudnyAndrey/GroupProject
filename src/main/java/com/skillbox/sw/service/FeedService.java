...
public class FeedService {
  ...
  public AbstractResponse getAllPosts(String token, String name, Integer offset,
      Integer itemPerPage) {
    Person person = personService.getCurrentPersonByToken(token);
    Integer id = person.getId();
    Page<ResponsePostApi> page = repository
        .getAllPosts(id, name, PageRequest.of(offset, itemPerPage))
