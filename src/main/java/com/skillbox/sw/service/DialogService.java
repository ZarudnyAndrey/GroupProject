...
import com.skillbox.sw.api.response.DialogListApi;
...
import com.skillbox.sw.api.response.MessageIdApi;
import com.skillbox.sw.api.response.MessageListApi;
import com.skillbox.sw.api.response.ReportApi;
import com.skillbox.sw.api.response.ResponseApi;
import com.skillbox.sw.api.response.ResponseDialogUsersApi;
import com.skillbox.sw.api.response.UnreadCount;
import com.skillbox.sw.api.response.UserApi;
...
public class DialogService {
  ...
  public AbstractResponse getUsersDialogList(String token, String query, int offset,
      int itemPerPage) {
  ...
  public AbstractResponse createDialog(UserIdListApi userList, String token) {
  ...
  public AbstractResponse sendMessage(int targetDialogId, MessageSendRequestBodyApi sentMessage,
      String token) {
  ...
  public AbstractResponse addUserToDialog(int dialogId, UserIdListApi userList) {
  ...
  @Transactional(readOnly = true)
  public AbstractResponse getDialogMessages(int dialogId, String query, int offset,
      int itemPerPage) {
  ...
  public Dialog getDialogById(int dialogId) {
    return dialogRepository.findById(dialogId)
        .orElseThrow(
            () -> new EntityNotFoundException("Dialog with Id - " + dialogId + " not found"));
  }
